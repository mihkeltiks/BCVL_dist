...
from datasets_dir.brains18 import BrainS18Dataset
...
parser.add_argument(        '--input_D',        default='8',        type=int,        help='depth')
parser.add_argument(        '--input_H',        default='32',        type=int,        help='height')
parser.add_argument(        '--input_W',        default='32',        type=int,        help='width')
...
def main():
    ...
    args.data_root = './toy_data'
    args.img_list = './toy_data/test_ci.txt'
    args.phase ='train'
...
#    criterion = nn.CrossEntropyLoss().to(device)
    ...
    if True:
        ...
        train_dataset = BrainS18Dataset(args.data_root, args.img_list, args)
        val_dataset = BrainS18Dataset(args.data_root, args.img_list, args)
    else:
...
#    top5 = AverageMeter('Acc@5', ':6.2f')
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        depth =  100
        images = torch.rand((1,1,depth,512,512), dtype=torch.bfloat16, device=device) # batch size, input channels, depth, height, width
        target = torch.randint(2,(1,1)) # label, either 0 or 1
...
#        images = images.to(device, non_blocking=True)
        ...
        print("RANK:",args.local_rank,"LOSS",loss)
...
#        top5.update(acc5[0], images.size(0))
        ...
        print("RANK: " + str(args.local_rank) + " - " + losses.summary())
